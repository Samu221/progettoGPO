    ...
    <?php
        ...
        if($row = mysqli_fetch_assoc($result)) {
           // echo "  <div class='container info'>";
            ...
            echo "          <table>";
            echo "              <tr><td>Lunedì </td><td>" . $row["lunedì"] . "</td></tr>";
            echo "              <tr><td>Martedì   </td><td>" . $row["martedì"] . "</td></tr>";
            echo "              <tr><td>Mercoledì </td><td>" . $row["mercoledì"] . "</td></tr>";
            echo "              <tr><td>Giovedì   </td><td>" . $row["giovedì"] . "</td></tr>";
            echo "              <tr><td>Venerdì  </td><td> " . $row["venerdì"] . "</td></tr>";
            echo "              <tr><td>Sabato   </td><td> " . $row["sabato"] . "</td></tr>";
            echo "              <tr><td>Domenica  </td><td>" . $row["domenica"] . "</td></tr>";
            echo "          </table>";
            echo "      </div>";
